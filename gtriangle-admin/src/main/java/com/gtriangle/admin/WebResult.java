...
import com.gtriangle.admin.json.JacksonJsonHandler;
...
public class WebResult {
	...
	public static void renderJsonSessionTimeOutMsg(HttpServletResponse response) {
		render(response, "application/json;charset=UTF-8", "{\"result\":0,\"msg\":\"账号登陆超时,请重新登录\"}",HttpServletResponse.SC_FORBIDDEN);
	}
	/**
	 * 发送json。使用UTF-8编码。
	 * 发送失败标示
